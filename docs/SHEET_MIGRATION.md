...
**Last updated:** 2026-08-20 19:04 (Announcement markdown cheat sheet)  
...
- **Announcement Text:** markdown (cheat-sheet basics + tables / strike / task lists / highlight). Plain CSV; xlsx rich runs stay quarantined. Alt+Enter = new line on the board. Type is hyphenated and scaled so it never leaves the Announcement Body. Authoring cheat sheet + the four demo examples: [ANNOUNCEMENT_MARKDOWN.md](./ANNOUNCEMENT_MARKDOWN.md).
