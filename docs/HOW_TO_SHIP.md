...
Open the ship form from [[Launcher]] → **Suite** or **Deployer** → **Live**, or here: [Suite](https://olitokip.github.io/OliToki/suite.html) · [Deployer](https://olitokip.github.io/OliToki/deploy.html). Suite, Deployer, Tickets, Menu Manager splash, and Listener home share the same tiny **← Suite** bar.
